        ...
        <div className="line">
          ...
          <div className="line__container">
            <p className="line__words">
              LONDON - PARIS - BEIJING - SYDNEY - TOKYO - NEW YORK - BERLIN -
              ROME - MOSСOW
            </p>
          </div>
        </div>
      ...
      <footer className="footer" id="Contacts">
        <div className="container footer__content">
          <div className="footer__flex">
            <span>
              Complaints and suggestions <br /> offer@inTime.ru
            </span>
            <span>
              Order or consultation question@inTime.ru <br /> 8(900) 777-45-33
              daily from 10.00 to 21.00
            </span>
            <span>
              Legal address 171793, Moscow region, <br /> Dubna, st. Tayson, d.
              9, apt. 32
            </span>
          </div>
          <div className="footer__flex">
